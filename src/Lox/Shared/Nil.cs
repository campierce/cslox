...
/// "literals can exist without a value," which is awkward and requires the added knowledge/handling
/// that null actually maps onto another concept.
/// </para>
/// </summary>
internal class Nil
{
    /// <summary>
    /// The one true Nil. Its one-ness means `nil == nil` without any special handling.
    /// </summary>
