...
internal class Parser
{
    ...
    /// </summary>
    /// <returns>A list of Expr that adhere to the rule.</returns>
    ...
    /// <summary>
    /// Parses the block rule.
    /// </summary>
    /// <returns>A list of Stmt that adhere to the rule.</returns>
    ...
    /// <summary>
    /// Represents an error during parsing. Allows the parser to communicate to itself when an
